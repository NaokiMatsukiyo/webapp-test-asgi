...
SECRET_KEY = 'x&2$j#amczq&hw!@rc7^!)^f+!fk&proebr00p9dwn7jgr#@ug'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            ...
            'ssl': {
                'ca': BASE_DIR / 'config/certs/BaltimoreCyberTrustRoot.crt.pem'
            }
        }
    }
}
